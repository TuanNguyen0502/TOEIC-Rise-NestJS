...
export const MessageConstant = {
  ...
  CORRECT_OPTION_NOT_BLANK: 'Correct option must not be blank.',
  QUESTION_CORRECT_OPTION_NOT_BLANK: 'Correct option must not be blank.',
  QUESTION_CORRECT_OPTION_NOT_NULL: 'Correct option must not be null.',
  EXPLAIN_NOT_BLANK: 'Explain must not be blank.',
  EXPLAIN_NOT_NULL: 'Explain must not be null.',
  QUESTION_EXPLANATION_NOT_BLANK: 'Explanation must not be blank.',
  QUESTION_EXPLANATION_NOT_NULL: 'Explanation must not be null.',
